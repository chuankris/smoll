...
public class MainActivity extends SwipeBackActivity implements View.OnClickListener
{
	...
	private int[] getColors()
	{
		if (mBgColors == null)
		{
			...
			mBgColors = new int[] { resource.getColor(R.color.androidColorA), resource.getColor(R.color.androidColorB),
			        resource.getColor(R.color.androidColorC), resource.getColor(R.color.androidColorD), resource.getColor(R.color.androidColorE), };
		}
		return mBgColors;
	}
